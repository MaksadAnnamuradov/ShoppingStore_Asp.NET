...
namespace ShoppingStore.Models
{
    public class Customer
    {
        ...
        [Required]
        [Display(Name = "Name")]
        [StringLength(56, ErrorMessage = "{0} must be at least {2} characters long.", MinimumLength = 2)]
        ...
        public string CustomerId
        {
            ...
            set {
                ...
                if (!(value.GetType() == typeof(string)))
                    throw new ArgumentException("CustomerId cannot be non string value");
                Id = value; 
            }
        }
        ...
        public string CustomerName
        {
            ...
            set {
                ...
                Regex ValidUserNameRegex = new Regex(@"(\.|\-|\._|\-_)$", RegexOptions.Compiled);
                if (string.IsNullOrWhiteSpace(value))
                    throw new ArgumentException("CustomerName cannot be empty");
                if (!ValidUserNameRegex.IsMatch(value))
                    throw new ArgumentException("Name should not contain special characters like '.', '-', '.' or '-'");
                Name = value; 
            }
        }
